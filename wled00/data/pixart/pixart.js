...
//  let locip = prompt("Режим файла. Введите IP устройства!");
...
gId("sendJSONledbutton").addEventListener('click', async () => {
  if (window.location.protocol === "https:") {
    alert('Будет доступен только при обслуживании по протоколу http (или WLED работает по протоколу https).');
  } else {
    postPixels();
  }
});
